...
for obstruction_position in obstruction_positions:
    new_map: list[str] = []
    new_map = generate_new_map(initial_map, obstruction_position)
...
print("Nombre de position qui font loop le garde :", loop_position_nb) # 1723 OK
