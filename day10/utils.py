...
def get_incremental_paths(path: list[tuple], topo_map: list[list]) -> list[list]:
...
def get_trailhead_score(hiking_trails: list[list]) -> int:
    """Détecte le nombre de sommets différents atteints par les hiking_trails en entrée.
    ...
    print("Trailhead score :", len(last_positions))
